...
const hotQuestions = [
  ...
  { _id: "4", title: "What are React Portals and when to use them?" },
...
const popularTags = [
  ...
  { _id: "4", name: "java", questions: 50 },
  { _id: "5", name: "tailwind", questions: 75 },
  { _id: "6", name: "react-query", questions: 75 },
];
...
const RightSideBar = () => {
  return (
    <section className="pt-36 custom-scrollbar background-light900_dark200 light-border sticky right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l p-6 shadow-light-300 dark:shadow-none max-xl:hidden">
      <div>
        <h3 className="h3-bold text-dak200_light900">Top Questions</h3>
